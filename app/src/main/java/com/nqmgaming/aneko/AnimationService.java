...
public class AnimationService extends Service {
    ...
    private void startAnimation() {
        ...
        touch_params.gravity = Gravity.START | Gravity.TOP;
    ...
    private boolean loadMotionState(ComponentName skin_comp) {
        ...
        motion_state.alpha = (int) ((1 - Float.parseFloat(alpha_str)) * 0xff);
    ...
    private class MotionState {
        ...
        private void updateState() {
            ...
            float deaccelerate_distance = params.getDecelerationDistance();
