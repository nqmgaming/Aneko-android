...
public class MotionParams {
    ...
    private static final String ATTR_DECELERATION = "decelerationDistance";
    ...
    private static final int DEF_DECELERATE_DISTANCE = 100; // dp
    ...
    private float deceleration_distance;
    ...
    private void parseMotion(Resources res,
        ...
        while (true) {
            ...
            if (TAG_ITEM.equals(name)) {
                parseItem(res, motion.items, attrs);
    ...
    private void parseItem(Resources res, MotionDrawable items,
        ...
        items.addFrame(ResourcesCompat.getDrawable(res, drawable, null), duration);
    }
